...
def test_valid_board():
    ...
    assert_that(validator.validate(board), equal_to("El input cumple las reglas de Sudoku"))

def test_empty_board_is_invalid():
    validator = Validator()
    board = []

    assert_that(validator.validate(board), equal_to("El input no cumple las reglas de Sudoku"))
